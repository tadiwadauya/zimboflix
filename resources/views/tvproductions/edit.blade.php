...
<div class="card card-bordered card-preview">
                            ...
                            <div class="nk-block-head nk-block-head-sm">
                                <div class="nk-block-between">
                                    <div class="nk-block-head-content">
                                        <h3 class="nk-block-title page-title">Edit TV Production</h3>
                    ...
                    <form action="{{ route('tvproductions.update',$tvproduction->id)}}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                        {{csrf_field()}}
                        ...
                        <input type="text" id="default-01" name="title" value="{{ $tvproduction->title }}" placeholder="Enter the title of the tvproduction" class="form-control @error('title') is-invalid @enderror">                        
                    </div>
                    @if ($errors->has('title'))
    ...
    <div class="form-group">
        ...
        <div class="form-control-wrap">
        <img src="{{ asset('cover_photos/' .$tvproduction->cover_photo) }}" alt="Current Cover Photo" width="100">
        <div class="form-file">
              <input type="file" class="form-file-input" id="cover_photo" name="cover_photo">
            <label class="form-file-label" for="customFile">Change Cover Photo</label>
        </div>
        </div>
    </div>
</div>
...
<div class="col-sm-9">
    ...
    <div class="form-control-wrap">
    <textarea name="description" id="description" class="form-control no-resize" placeholder="Enter a description of the tvproduction">{{ $tvproduction->title }}</textarea>
...
<div class="col-sm-9">
    ...
    <video width="200" height="120" controls>
     <source src="{{ asset('videos/' . $tvproduction->file) }}" type="video/mp4">
      Your browser does not support the video tag.
      </video>    
    <div class="form-file">
    <input type="file" class="form-file-input" name="file" id="file">
    <label class="form-file-label" for="customFile">Change video</label>
        </div>
    @if ($errors->has('file'))
        <span class="help-block">
...
<div class="col-sm-9">
    ...
    <option value="{{ $tvproduction->country }}" data-capital="Kabul">{{ $tvproduction->country }}</option>    
...
<div class="col-sm-9">
    ...
    <div class="form-control-wrap">
    <input type="date" class="form-control" name="release_date" value="{{ $tvproduction->release_date }}" id="release_date">
...
<div class="col-sm-9">
    ...
    <div class="form-control-wrap">
    <input type="text" class="form-control" value="{{ $tvproduction->director }}" name="director" id="director" placeholder="Enter the director of the tvproduction">
...
<div class="col-sm-9">
    ...
    <div class="form-control-wrap">
    <input type="text" class="form-control" value="{{ $tvproduction->production_company }}" name="production_company" id="production_company" placeholder="Enter the production company of the tvproduction">
...
<div class="col-sm-9">
    ...
    <div class="form-control-wrap">
    <input type="text" class="form-control" value="{{ $tvproduction->cast }}" name="cast" id="cast" placeholder="Enter the cast of the tvproduction">
    @if ($errors->has('cast'))
        <span class="help-block">
    ...
    <div class="form-group">
        ...
        <div class="form-control-wrap">
            <select name="category_id" class="form-control" id="category_id">
                <option value="{{ $tvproduction->category_id }}">{{ $tvproduction->category->name }}</option>
...
<progress class="progress-bar" id="uploadProgress" value="0" max="100"></progress>
    ...
    <div class="card card-bordered card-preview">
                                ...
                                <div class="form-group" >
            <input type="submit" value="Update tvproduction" class="btn btn-primary" >
