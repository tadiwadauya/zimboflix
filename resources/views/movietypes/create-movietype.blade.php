                            ...
                            <div class="nk-block-head nk-block-head-sm">
                                <div class="nk-block-between">
                                    <div class="nk-block-head-content">
                                        <h3 class="nk-block-title page-title">Adding new movietype</h3>
                                                        ...
                                                        <div class="drodown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                <ul class="link-list-opt no-bdr">
                                                                    ...
                                                                    <li><a href="{{ url('/categories/create')}}">  <em class="icon ni ni-plus-fill-c"></em><span>Add movietype</span></a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </li>
...
<form method="POST" action="{{ route('movietypes.store') }}">
    @csrf
    <div class="row gy-4">
    <div class="col-sm-9">
    <div class="form-group">
        <label class="form-label" for="default-01" for="name">movietype Name:</label>
    ...
    <br>
    <div class="form-group" > 
    <button type="submit" class="btn btn-primary">Create movietype</button>
</div>
</form>
</div>
</div>
